...
<ItemCart key={product.id} product={product} totalPrice={totalPrice} removeProductInCart={removeProductInCart} />
 ...
 <Link to={`/product/`}>
<button class="flex font-semibold text-sky-500 text-sm mt-10">
...
<button class="bg-sky-500 hover:bg-sky-600 px-3 py-2 text-sm rounded text-white">Aplicar</button>
<div class="border-t mt-8">
<div class="flex font-semibold justify-between py-6 text-sm uppercase">
  <span>Precio Total</span>
  <span>${totalPrice}</span>
</div>
<button class="bg-sky-500 rounded font-semibold hover:bg-sky-600 py-3 text-sm text-white uppercase w-full">Terminar Compra</button>
<button
