...
<svg className="fill-current mr-2 text-sky-500 w-4" viewBox="0 0 448 512"><path d="M134.059 296H436c6.627 0 12-5.373 12-12v-56c0-6.627-5.373-12-12-12H134.059v-46.059c0-21.382-25.851-32.09-40.971-16.971L7.029 239.029c-9.373 9.373-9.373 24.569 0 33.941l86.059 86.059c15.119 15.119 40.971 4.411 40.971-16.971V296z"/></svg>
Agregar Productos
</button>
</Link>
</div>
...
<h1 className="font-semibold text-2xl border-b pb-8">Resumen Carrito</h1>
<div className="flex justify-between mt-10 mb-5">
<span className="font-semibold text-sm">Total Productos: {total}</span>
</div>
<div>
...
<div className="py-7">
<label for="promo" className="font-semibold inline-block mb-3 text-sm uppercase">Codigo de Descuento</label>
<input type="text" id="promo" placeholder="Introduce el codigo" className="p-2 text-sm w-full"/>
</div>
<button className="bg-sky-500 hover:bg-sky-600 px-3 py-2 text-sm rounded text-white">Aplicar</button>
...
<Link to={`/checkout/`}>
<button className="bg-sky-500 rounded font-semibold hover:bg-sky-600 py-3 text-sm text-white uppercase w-full">Terminar Pedido</button>
</Link>
<button
