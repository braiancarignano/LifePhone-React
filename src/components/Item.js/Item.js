  ...
  return (
    <div className="w-80 bg-white shadow-xl rounded-xl  m-8">
      ...
      <div className="p-4 flex flex-col items-center">
        <h2 className="text-gray-800 capitalize 	font-bold text-center">{brand}</h2>
        <h3 className="text-gray-800 text-center mt-1">{name}</h3>
        <h3 className="text-gray-800 text-center mt-1">{price}</h3>
