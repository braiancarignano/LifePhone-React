...
<div className="relative inline-block text-left">
  <div className="absolute right-9 z-10 p-3 mt-4 w-56 rounded-lg border-2  bg-white shadow-lg ring-black ring-opacity-5 focus:outline-none" role="menu" aria-orientation="vertical" aria-labelledby="menu-button" tabindex="-1">
    ...
    <Link to={`/product/brand/apple`}>
      <button className="text-gray-700 border-b-2 block w-full text-left px-4 py-1 text-sm" role="menuitem" tabindex="-1" id="menu-item-2">Apple</button>
    </Link>
    <Link to={`/product/brand/samsung`}>
      <button className="text-gray-700 border-b-2 block w-full text-left px-4 py-1 text-sm" role="menuitem" tabindex="-1" id="menu-item-0">Samsung</button>
      </Link>
